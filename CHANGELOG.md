...
- Added JSONL/simple CSV input, deterministic CSV output, action/failure/stage/skipped statistics, RA011/RA012, public canonical model types, pure MoonBit SHA-256 manifests, file verification, 77 tests, and native benchmarks.
